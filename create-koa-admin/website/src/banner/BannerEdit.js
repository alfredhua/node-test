...
import LongInput from '@common/input/LongInput';
import DefaultInputNumber from '@common/input/DefaultInputNumber';
...
export default class BannerEditForm extends React.Component{
  ...
  render(){
    const {fileList,previewVisible,type}=this.state;
    const uploadButton = (
      <div>
        <Icon type='plus' />
