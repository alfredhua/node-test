...
import { Breadcrumb,Card,Form,Modal,message,Button,Upload,Input,Icon } from 'antd';
import { Link } from 'react-router-dom'
import DefaultBraftEditor from '@common/editor/DefaultBraftEditor';
    ...
    async load_data(){
      ...
      if(id){
        ...
        if(code==='SUCCESS'){
          ...
          setFieldsValue({ title,source,source_url,introduce,pic});
