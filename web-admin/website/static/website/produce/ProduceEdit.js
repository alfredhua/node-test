...
class ProduceEdit extends React.Component{
    ...
    async load_data(id){
      let {data,code,msg}=await post("/website/get-produce",{id});
      console.log(data);
      if(code==='SUCCESS'){
    ...
    render(){
      ...
      const {load_file_list,cover_file_list,file_list,preview_visible,preview_image,cover_visible,cover_image} =this.state;
      return(
        <div>
          ...
          <Form {...formItemLayout} onSubmit={this.submit}>
                <Form.Item label="产品名称">
                 ...
                 {/*  <Form.Item label="PC展示">
              {getFieldDecorator('pc_show')(
                  <Radio.Group>
              ...
              <Form.Item label="手机站展示" >
                {getFieldDecorator('m_show')(
                  <Radio.Group>
                    <Radio value={0}>否</Radio>
                    <Radio value={1}>是</Radio>
                  </Radio.Group>,
